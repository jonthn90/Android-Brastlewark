...
class SearchByNameTest {
    ...
    @Before
    fun setUp() {
        searchByName = SearchByName(inhabitantsRepository)
    }
    ...
    fun `invoke calls repository`() {
        runBlocking {
            ...
            whenever(inhabitantsRepository.searchByName("Frederic")).thenReturn(inhabitants)

            val result = searchByName.invoke("Frederic")
